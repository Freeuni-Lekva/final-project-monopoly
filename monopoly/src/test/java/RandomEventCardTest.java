import DAO.CardsDAO;
import cardTypes.RandomEventCardPile;
...
public class RandomEventCardTest extends TestCase {
    ...
    public void testChanceCards() throws SQLException {
        ...
        RandomEventCardPile rec = new RandomEventCardPile(cardsDAO.getChanceCards(), "chance-get-out-of-jail.png");
    ...
    public void testCommunityChestCards() throws SQLException {
        CardsDAO cardsDAO = new CardsDAO();
        RandomEventCardPile rec = new RandomEventCardPile(cardsDAO.getCommunityChestCards(),
