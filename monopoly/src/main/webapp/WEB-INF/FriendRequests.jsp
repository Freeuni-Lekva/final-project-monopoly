...
<%
    ...
    <li>
        <p><%=friend%></p>
        <button onclick="var xmlHttp = new XMLHttpRequest(); xmlHttp.open( 'GET', '/acceptRequest', false ); xmlHttp.setRequestHeader('AcceptedUser','<%=friend%>'); xmlHttp.send(); location.reload();" >Accept</button>
        <button onclick="var xmlHttp = new XMLHttpRequest(); xmlHttp.open( 'GET', '/declineRequest', false ); xmlHttp.setRequestHeader('DeclinedUser','<%=friend%>'); xmlHttp.send(); location.reload();">Decline</button>
    </li>
<%}%>
</ul>
</body>
