...
public class CardsDAO {
    ...
    private final int PROPERTY_CARDS_DATA_SIZE = 14;
    private final int RAILROAD_CARDS_DATA_SIZE = 8;
    private final int UTILITY_CARDS_DATA_SIZE = 4;
    ...
    public int getColorSetSize(String color) throws SQLException {
